...
<Tip>If your project only uses one API (like most projects that include a custom backend), please consider using <a href="#version-1--only-single-api">this implementation</a></Tip>
...
<TryBadge kind="hooks-useapi-v1-only-single-api" story="default" />
...
<TryBadge kind="hooks-useapi-v2-⭐-apis-as-components" story="default" />
